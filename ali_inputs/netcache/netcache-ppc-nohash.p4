...
action hh_load_1_count_act() {
    modify_field(nc_load_md.index_1, nc_hdr.key);
    add_to_field(nc_load_md.index_1, 1);
    register_read(nc_load_md.load_1, hh_load_1_reg, nc_load_md.index_1);
    add_to_field(nc_load_md.load_1, 1);
    register_write(hh_load_1_reg, nc_load_md.index_1, nc_load_md.load_1);
    add_to_field(nc_load_md.load_1, -1);
}
...
action hh_load_2_count_act() {
    modify_field(nc_load_md.index_2, nc_hdr.key);
    add_to_field(nc_load_md.index_2, 2);
    register_read(nc_load_md.load_2, hh_load_2_reg, nc_load_md.index_2);
    add_to_field(nc_load_md.load_2, 1);
    register_write(hh_load_2_reg, nc_load_md.index_2, nc_load_md.load_2);
    add_to_field(nc_load_md.load_2, -1);
}
...
action hh_load_3_count_act() {
    modify_field(nc_load_md.index_3, nc_hdr.key);
    add_to_field(nc_load_md.index_3, 3);
    register_read(nc_load_md.load_3, hh_load_3_reg, nc_load_md.index_3);
    add_to_field(nc_load_md.load_3, 1);
    register_write(hh_load_3_reg, nc_load_md.index_3, nc_load_md.load_3);
    add_to_field(nc_load_md.load_3, -1);
}
...
action hh_load_4_count_act() {
    modify_field(nc_load_md.index_4, nc_hdr.key);
    add_to_field(nc_load_md.index_4, 4);
    register_read(nc_load_md.load_4, hh_load_4_reg, nc_load_md.index_4);
    add_to_field(nc_load_md.load_4, 1);
    register_write(hh_load_4_reg, nc_load_md.index_4, nc_load_md.load_4);
    add_to_field(nc_load_md.load_4, -1);
}
...
action hh_bf_1_act() {
    modify_field(hh_bf_md.index_1, nc_hdr.key);
    add_to_field(hh_bf_md.index_1, 1);
...
action hh_bf_2_act() {
    modify_field(hh_bf_md.index_2, nc_hdr.key);
    add_to_field(hh_bf_md.index_2, 2);
...
action hh_bf_3_act() {
    modify_field(hh_bf_md.index_3, nc_hdr.key);
    add_to_field(hh_bf_md.index_3, 3);
...
action clone_to_controller_act() {
    clone_egress_pkt_to_egress(3, mirror_list);
}
